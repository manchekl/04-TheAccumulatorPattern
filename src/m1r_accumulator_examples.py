...
#
#              for k in range(r - s): **the dash should be a comma**
#                  count = 0 **count will always return to zero**
#                  if math.cos(r) > 0: **if statement should be in parenthesis
#                      count = 1 **changes the count to one instead of adding it to the total number**
#                  return count **will return only 0 or 1 at this point**
#
...
#
#              x = starting_point.x ** this one is wrong because it doesnt changed the x value like the above and below functions do
#              for k in range(n):
